...
- [ ] **Task 1: Create Q&A Synthesis Agent** (AC: 1, 2)
  - [ ] Create `agents/qaAdvisor.ts`
  - [ ] Configure with Claude Sonnet 4 model
  - [ ] Write Q&A system prompt
  - [ ] Include citation instructions

- [ ] **Task 2: Create Synthesis Action** (AC: 1, 3, 4)
  - [ ] Create `convex/ai/qa.ts`
  - [ ] Implement `synthesizeAnswer` action
  - [ ] Build context from search results
  - [ ] Format response with citations

- [ ] **Task 3: Implement Inline Citations** (AC: 3)
  - [ ] Define citation format (e.g., [1], [2])
  - [ ] Map citations to source URLs
  - [ ] Include sources list at end

- [ ] **Task 4: Handle Multilingual Output** (AC: 5)
  - [ ] Pass user's language to prompt
  - [ ] Instruct Claude to respond in that language
  - [ ] Verify output language matches request

- [ ] **Task 5: Add Token Usage Logging** (AC: 6)
  - [ ] Track input/output tokens
  - [ ] Log to monitoring system
  - [ ] Store in Convex for cost analysis

- [ ] **Task 6: Optimize Response Time** (AC: 7)
  - [ ] Enable streaming for faster first token
  - [ ] Parallelize retrieval where possible
  - [ ] Monitor and log timing

- [ ] **Task 7: Integrate with Chat Flow** (AC: 1-6)
  - [ ] Connect synthesis to CopilotKit runtime
  - [ ] Pass context from useCopilotReadable
