...
- [ ] **Task 1: Create ElevenLabs Client** (AC: 1)
  - [ ] Create `lib/elevenlabs.ts`
  - [ ] Add `ELEVENLABS_API_KEY` to environment
  - [ ] Implement TTS function
  - [ ] Handle API errors

- [ ] **Task 2: Configure Voice Selection** (AC: 2)
  - [ ] Map languages to ElevenLabs voice IDs
  - [ ] Select appropriate voice per language
  - [ ] Default to multilingual voice

- [ ] **Task 3: Create TTS Action** (AC: 1, 3, 6)
  - [ ] Create `convex/ai/tts.ts`
  - [ ] Implement `generateAudio` action
  - [ ] Store audio in Convex file storage
  - [ ] Return audio URL

- [ ] **Task 4: Implement Background Generation** (AC: 6)
  - [ ] Use Convex scheduled function
  - [ ] Trigger on briefing creation
  - [ ] Update briefing with audio URL

- [ ] **Task 5: Create Audio Player Hook** (AC: 4, 5)
  - [ ] Create `hooks/useAudioPlayer.ts`
  - [ ] Implement play, pause, seek
  - [ ] Add speed adjustment (0.75x - 1.5x)
  - [ ] Track playback progress

- [ ] **Task 6: Implement Fallback** (AC: 7)
  - [ ] Detect audio generation failure
  - [ ] Display text transcript instead
  - [ ] Show retry button

- [ ] **Task 7: Add Audio Status to Schema** (AC: 3)
  - [ ] Add `audioUrl` field to briefings
  - [ ] Add `audioStatus` field (pending, ready, failed)
  - [ ] Add `audioDuration` field
