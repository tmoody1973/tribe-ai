...
- [ ] **Task 1: Create Briefing Script Agent** (AC: 1, 2, 3)
  - [ ] Create `agents/briefingWriter.ts`
  - [ ] Configure Claude Sonnet 4 model
  - [ ] Write NPR-style system prompt
  - [ ] Include language instructions

- [ ] **Task 2: Create Script Generation Action** (AC: 1, 4, 5)
  - [ ] Create `convex/ai/briefings.ts`
  - [ ] Implement `generateBriefingScript` action
  - [ ] Gather user context (corridor, stage, progress)
  - [ ] Control script length by briefing type

- [ ] **Task 3: Add Briefings Schema** (AC: 6)
  - [ ] Add `briefings` table to schema
  - [ ] Fields: userId, corridorId, type, script, createdAt
  - [ ] Index by user and corridor

- [ ] **Task 4: Implement Script Caching** (AC: 6, 7)
  - [ ] Save generated scripts to Convex
  - [ ] Check for existing script before generating
  - [ ] Invalidate on progress change

- [ ] **Task 5: Create Briefing Types** (AC: 4)
  - [ ] Daily briefing (2-3 min, ~400 words)
  - [ ] Weekly briefing (5-7 min, ~1000 words)
  - [ ] Progress update (1-2 min, ~200 words)

- [ ] **Task 6: Add Source Attribution** (AC: 5)
  - [ ] Include sources naturally in script
  - [ ] "According to expats who've done this..."
  - [ ] Reference community knowledge

- [ ] **Task 7: Detect Significant Changes** (AC: 7)
  - [ ] Track last briefing generation time
  - [ ] Compare current progress to last briefing
  - [ ] Trigger regeneration on significant delta
