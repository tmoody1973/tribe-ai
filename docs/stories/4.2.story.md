...
- [ ] **Task 1: Configure Voyage AI Client** (AC: 1)
  - [ ] Add `VOYAGE_API_KEY` to Convex environment
  - [ ] Create `lib/voyage.ts` with embed function
  - [ ] Configure voyage-3 model (1024 dimensions)
  - [ ] Add error handling for API calls

- [ ] **Task 2: Create Query Embedding Action** (AC: 2)
  - [ ] Create `convex/ai/embeddings.ts`
  - [ ] Implement `embedQuery` action
  - [ ] Handle rate limiting
  - [ ] Cache embeddings for identical queries

- [ ] **Task 3: Implement Vector Search** (AC: 2, 3)
  - [ ] Create `convex/ai/search.ts`
  - [ ] Implement `searchRelevantContent` action
  - [ ] Use Convex vector index `by_embedding`
  - [ ] Return top 10 results by similarity

- [ ] **Task 4: Filter by Corridor** (AC: 5)
  - [ ] Add corridorId filter to vector search
  - [ ] Use Convex filter fields in vector index
  - [ ] Validate corridor filter works

- [ ] **Task 5: Include Metadata in Results** (AC: 4)
  - [ ] Ensure ingestedContent has required fields
  - [ ] Return source URL, author, date, engagement
  - [ ] Format results for synthesis

- [ ] **Task 6: Implement Fallback Search** (AC: 6)
  - [ ] Check result count after corridor filter
  - [ ] If < 3 results, search without corridor filter
  - [ ] Mark results as "general" vs "corridor-specific"
  - [ ] Log fallback events

- [ ] **Task 7: Optimize for Latency** (AC: 7)
  - [ ] Add timing logs to measure latency
  - [ ] Optimize embedding generation
  - [ ] Use Convex edge for faster queries
