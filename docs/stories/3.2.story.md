...
- [ ] **Task 1: Create Protocol Card Component** (AC: 2, 5)
  - [ ] Create `components/protocol/ProtocolCard.tsx`
  - [ ] Display step number, title, description
  - [ ] Add expand/collapse functionality
  - [ ] Style with RetroUI card pattern
  - [ ] Add category icon/color

- [ ] **Task 2: Create Protocol List Component** (AC: 1, 6)
  - [ ] Create `components/protocol/ProtocolList.tsx`
  - [ ] Render cards in order (by `order` field)
  - [ ] Add connecting line between cards (timeline style)
  - [ ] Handle empty state

- [ ] **Task 3: Add Warning Display** (AC: 3)
  - [ ] Create warning section in ProtocolCard
  - [ ] Style with red/orange alert colors
  - [ ] Show warning icon (⚠️)
  - [ ] Expand to show all warnings

- [ ] **Task 4: Add Hacks/Tips Display** (AC: 4)
  - [ ] Create tips section in ProtocolCard
  - [ ] Style with green success colors
  - [ ] Show lightbulb icon (💡)
  - [ ] Expand to show all tips

- [ ] **Task 5: Implement Current Step Emphasis** (AC: 7)
  - [ ] Detect current step (first incomplete)
  - [ ] Add visual emphasis (larger, glowing border)
  - [ ] Show "Current Step" badge
  - [ ] Scroll to current step on load

- [ ] **Task 6: Add Category Styling** (AC: 2)
  - [ ] Define colors per category (visa, finance, housing, etc.)
  - [ ] Add category badge to each card
  - [ ] Icon per category

- [ ] **Task 7: Add Protocol Translations** (AC: 2)
  - [ ] Add category names to locale files
  - [ ] Add priority labels
  - [ ] Add status labels
