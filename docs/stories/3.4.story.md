...
- [ ] **Task 1: Create Progress Data Model** (AC: 2, 6)
  - [ ] Add `userProgress` table to Convex schema
  - [ ] Fields: userId, corridorId, protocolId, completedAt
  - [ ] Create index on userId + corridorId
  - [ ] Create `markComplete` mutation
  - [ ] Create `markIncomplete` mutation
  - [ ] Create `getProgress` query

- [ ] **Task 2: Add Checkbox to ProtocolCard** (AC: 1, 4)
  - [ ] Add completion checkbox to ProtocolCard header
  - [ ] Style checkbox with RetroUI pattern
  - [ ] Call `markComplete` mutation on check
  - [ ] Call `markIncomplete` mutation on uncheck
  - [ ] Optimistic update for immediate feedback

- [ ] **Task 3: Create Progress Bar Component** (AC: 3)
  - [ ] Create `components/protocol/ProgressBar.tsx`
  - [ ] Calculate percentage from completed/total
  - [ ] Style with RetroUI thick borders
  - [ ] Animate fill on change
  - [ ] Show percentage label

- [ ] **Task 4: Style Completed Steps** (AC: 4)
  - [ ] Reduce opacity for completed cards
  - [ ] Show checkmark instead of step number
  - [ ] Strikethrough title
  - [ ] Move completed to bottom (optional)

- [ ] **Task 5: Add Celebration Animation** (AC: 5)
  - [ ] Create confetti animation on completion
  - [ ] Use Framer Motion for animation
  - [ ] Trigger only on new completions
  - [ ] Brief animation (1-2 seconds)

- [ ] **Task 6: Add Reset Progress Option** (AC: 7)
  - [ ] Add "Reset Progress" to settings page
  - [ ] Create `resetProgress` mutation
  - [ ] Confirmation dialog before reset
  - [ ] Clear all progress for current corridor

- [ ] **Task 7: Integrate with ProtocolList** (AC: 1-6)
  - [ ] Fetch progress in ProtocolList
  - [ ] Pass completion state to each ProtocolCard
  - [ ] Add ProgressBar above card list
  - [ ] Update progress on completion change
