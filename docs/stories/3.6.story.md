...
- [ ] **Task 1: Create Expanded Stats Panel Component** (AC: 1, 2, 4, 5)
  - [ ] Create `components/corridor/CorridorStatsPanel.tsx`
  - [ ] Display visa type and processing time
  - [ ] Show cost of living comparison
  - [ ] Display timezone difference
  - [ ] Show destination language

- [ ] **Task 2: Create Cost Comparison Component** (AC: 2)
  - [ ] Create `components/corridor/CostComparison.tsx`
  - [ ] Bar chart or comparison cards for costs
  - [ ] Categories: rent, groceries, transport, utilities
  - [ ] Show percentage difference (cheaper/more expensive)

- [ ] **Task 3: Create Currency Conversion Component** (AC: 3)
  - [ ] Create `components/corridor/CurrencyConverter.tsx`
  - [ ] Display exchange rate (1 origin = X destination)
  - [ ] Show currency symbols and names
  - [ ] Update on exchange rate changes

- [ ] **Task 4: Create Timezone Display Component** (AC: 4)
  - [ ] Create `components/corridor/TimezoneCompare.tsx`
  - [ ] Show both timezones with current time
  - [ ] Calculate hour difference
  - [ ] Visual clock representation (optional)

- [ ] **Task 5: Fetch and Display Stats Data** (AC: 6, 7)
  - [ ] Use `getCorridorBaseline` action from Story 2.2
  - [ ] Handle loading states
  - [ ] Handle missing data gracefully
  - [ ] Re-fetch when corridor changes

- [ ] **Task 6: Create Stats Loading Skeleton** (AC: 6)
  - [ ] Create skeleton for stats panel
  - [ ] Animate with pulse effect
  - [ ] Match final layout dimensions

- [ ] **Task 7: Add Stats Translations** (AC: 1-5)
  - [ ] Add stat labels to locale files
  - [ ] Add comparison phrases ("X% higher", "X hours ahead")
  - [ ] Translate for all 5 languages
...
export function CostComparison({
  ...
  const categories = [
    { key: "rent", label: t("rent"), icon: "🏠", data: costs.rent },
    { key: "groceries", label: t("groceries"), icon: "🛒", data: costs.groceries },
    { key: "transport", label: t("transport"), icon: "🚌", data: costs.transport },
    { key: "utilities", label: t("utilities"), icon: "💡", data: costs.utilities },
  ];
...
components/
└── corridor/
    ├── CorridorStatsPanel.tsx     # Main stats panel
    ├── CostComparison.tsx         # Cost comparison bars
    ├── CurrencyConverter.tsx      # Currency converter
    ├── TimezoneCompare.tsx        # Timezone display
    └── StatsLoadingSkeleton.tsx   # Loading skeleton
```
