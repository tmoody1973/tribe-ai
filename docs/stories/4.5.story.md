...
- [ ] **Task 1: Create Sources Component** (AC: 1, 2, 3)
  - [ ] Create `components/chat/SourcesList.tsx`
  - [ ] Display source title, URL, date, author
  - [ ] Make URLs clickable (new tab)
  - [ ] Style with RetroUI

- [ ] **Task 2: Add Source Count Header** (AC: 4)
  - [ ] Show "Based on X sources" above list
  - [ ] Differentiate community vs real-time counts
  - [ ] Handle singular/plural

- [ ] **Task 3: Add Source Type Badges** (AC: 5)
  - [ ] Create badge for "Community" sources
  - [ ] Create badge for "Real-time" sources
  - [ ] Style badges distinctly

- [ ] **Task 4: Add Freshness Indicator** (AC: 6)
  - [ ] Show date of oldest source
  - [ ] Show date of most recent source
  - [ ] Add "as of [date]" label
  - [ ] Warning for sources > 6 months old

- [ ] **Task 5: Make Sources Collapsible** (AC: 7)
  - [ ] Default collapsed on mobile
  - [ ] Default expanded on desktop
  - [ ] Toggle button to expand/collapse
  - [ ] Smooth animation

- [ ] **Task 6: Integrate with Chat Messages** (AC: 1-7)
  - [ ] Add SourcesList to assistant messages
  - [ ] Pass source data from synthesis
  - [ ] Handle messages without sources

- [ ] **Task 7: Add Sources Translations** (AC: 1-6)
