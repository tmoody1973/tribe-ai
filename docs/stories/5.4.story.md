...
- [ ] **Task 1: Create ElevenLabs STT Client** (AC: 2)
  - [ ] Add STT endpoint to `lib/elevenlabs.ts`
  - [ ] Handle audio format (webm/mp3)
  - [ ] Return transcribed text

- [ ] **Task 2: Create Voice Input Button** (AC: 1, 3)
  - [ ] Create `components/chat/VoiceInputButton.tsx`
  - [ ] Implement push-to-talk (hold to record)
  - [ ] Use Web Audio API for recording
  - [ ] Handle browser permissions

- [ ] **Task 3: Add Recording Indicator** (AC: 4)
  - [ ] Create `components/chat/RecordingIndicator.tsx`
  - [ ] Animate waveform or pulsing icon
  - [ ] Show recording duration
  - [ ] Red color to indicate recording

- [ ] **Task 4: Create Transcription Preview** (AC: 5)
  - [ ] Show transcribed text in preview area
  - [ ] Loading state during transcription
  - [ ] Handle transcription errors

- [ ] **Task 5: Enable Transcription Editing** (AC: 6)
  - [ ] Editable text field with transcription
  - [ ] "Send" and "Cancel" buttons
  - [ ] Re-record option

- [ ] **Task 6: Add Language Support** (AC: 7)
  - [ ] Pass user's language to STT API
  - [ ] Configure language hints
  - [ ] Handle multilingual output

- [ ] **Task 7: Integrate with Chat** (AC: 1-7)
  - [ ] Add voice button to ChatInput
  - [ ] Submit transcription to chat
  - [ ] Handle voice input flow
