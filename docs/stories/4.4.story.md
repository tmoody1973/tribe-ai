...
- [ ] **Task 1: Create Query Classifier** (AC: 1)
  - [ ] Create `lib/queryClassifier.ts`
  - [ ] Define real-time query patterns
  - [ ] Use LLM or regex for classification
  - [ ] Return classification result

- [ ] **Task 2: Create Perplexity Client** (AC: 2)
  - [ ] Create `lib/perplexity.ts`
  - [ ] Add `PERPLEXITY_API_KEY` to environment
  - [ ] Implement search function
  - [ ] Handle API responses

- [ ] **Task 3: Implement Perplexity Action** (AC: 2, 3)
  - [ ] Create `convex/ai/perplexity.ts`
  - [ ] Implement `searchRealtime` action
  - [ ] Format results for synthesis
  - [ ] Include source URLs

- [ ] **Task 4: Add Source Attribution** (AC: 4)
  - [ ] Parse Perplexity citations
  - [ ] Mark sources as "Perplexity" type
  - [ ] Include in synthesis context

- [ ] **Task 5: Implement Confidence Check** (AC: 5)
  - [ ] Define low confidence threshold
  - [ ] Check RAG result scores
  - [ ] Trigger Perplexity on low confidence

- [ ] **Task 6: Add Rate Limiting** (AC: 6)
  - [ ] Create Upstash Redis rate limiter
  - [ ] Set per-user rate limits
  - [ ] Handle limit exceeded gracefully

- [ ] **Task 7: Log Perplexity Usage** (AC: 7)
  - [ ] Track API calls per user
  - [ ] Log query and response size
  - [ ] Monitor for cost analysis
